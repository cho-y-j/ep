...
export const NOTIFICATION_GROUPS: { key: NotificationGroupKey; label: string; types: string[] }[] = [
  ...
  { key: 'document', label: '서류', types: ['DOCUMENT_REJECTED', 'DOCUMENT_OCR_REVIEW', 'DOCUMENT_VERIFIED', 'DOCUMENT_EXPIRING', 'DOCUMENT_EXPIRED', 'DOCUMENT_EXPIRY_EXTRACTED', 'DOCUMENT_RENEWED', 'DOCUMENT_REVIEW', 'DOCUMENT_REVIEW_RESULT', 'SUPPLEMENT_REQUESTED', 'SUPPLEMENT_RESOLVED'] },
