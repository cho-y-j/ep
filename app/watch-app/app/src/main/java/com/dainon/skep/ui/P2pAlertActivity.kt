...
class P2pAlertActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        wakeLock = (getSystemService(POWER_SERVICE) as PowerManager)
            .newWakeLock(PowerManager.SCREEN_BRIGHT_WAKE_LOCK or PowerManager.ACQUIRE_CAUSES_WAKEUP, "skep:p2p_alert")
    ...
    override fun onResume() {
        super.onResume()
        registerReceiver(distanceReceiver, IntentFilter("com.dainon.skep.P2P_DISTANCE"), RECEIVER_NOT_EXPORTED)
        registerReceiver(closeReceiver, IntentFilter("com.dainon.skep.CLOSE_P2P"), RECEIVER_NOT_EXPORTED)
    }
