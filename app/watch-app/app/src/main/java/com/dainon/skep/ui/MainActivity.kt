...
import com.dainon.skep.service.AlertService
import com.dainon.skep.service.BleAlertService
import com.dainon.skep.service.SensorService
...
class MainActivity : AppCompatActivity() {
    ...
    private val p2pReceiver = object : BroadcastReceiver() {
        override fun onReceive(ctx: Context, intent: Intent) {
            ...
            val prefs = getSharedPreferences("skep", MODE_PRIVATE)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val sensorRunning = try {
            ...
            manager.getRunningServices(100).any { it.service.className == "com.dainon.skep.service.SensorService" }
    ...
    private fun startRest() {
        ...
        getSharedPreferences("skep", MODE_PRIVATE).edit()
    ...
    override fun onResume() {
        super.onResume()
        registerReceiver(sensorReceiver, IntentFilter("com.dainon.skep.SENSOR_UPDATE"), RECEIVER_NOT_EXPORTED)
        registerReceiver(alertReceiver, IntentFilter("com.dainon.skep.NEW_ALERT"), RECEIVER_NOT_EXPORTED)
        registerReceiver(p2pReceiver, IntentFilter("com.dainon.skep.P2P_ALERT"), RECEIVER_NOT_EXPORTED)
        registerReceiver(autoEndWorkReceiver, IntentFilter("com.dainon.skep.AUTO_END_WORK"), RECEIVER_NOT_EXPORTED)
        registerReceiver(watchBackOnReceiver, IntentFilter("com.dainon.skep.WATCH_BACK_ON"), RECEIVER_NOT_EXPORTED)
    }
