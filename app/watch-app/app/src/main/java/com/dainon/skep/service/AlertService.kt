...
import com.dainon.skep.data.AlertMessage
...
class AlertService : Service() {
            ...
            while (isActive) {
                try {
                    ...
                    if (alerts.isNotEmpty()) {
                        ...
                        // 전체 알림 내역 브로드캐스트
                        sendBroadcast(Intent("com.dainon.skep.ALERT_LIST_UPDATE").apply {
    ...
    private fun broadcastAlert(alert: AlertMessage) {
        sendBroadcast(Intent("com.dainon.skep.NEW_ALERT").apply {
