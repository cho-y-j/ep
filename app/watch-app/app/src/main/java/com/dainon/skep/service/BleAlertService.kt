...
object BleAlertService {
    ...
    private fun processScanResult(context: Context, result: ScanResult) {
        ...
        if (status == 'E') {
            ...
            val prefs = appCtx.getSharedPreferences("skep", Context.MODE_PRIVATE)
            ...
            appCtx.sendBroadcast(Intent("com.dainon.skep.P2P_DISTANCE").apply {
            ...
            if (workerId in activeEmergencyWorkers) {
                ...
                context.applicationContext.sendBroadcast(Intent("com.dainon.skep.CLOSE_P2P").apply {
                    setPackage("com.dainon.skep")
                })
    ...
    private fun vibrateByDistance(context: Context, intensityPercent: Int, zone: String = "ZONE3") {
        ...
        // 설정 체크 (진동 끄기)
        val prefs = context.applicationContext.getSharedPreferences("skep", Context.MODE_PRIVATE)
