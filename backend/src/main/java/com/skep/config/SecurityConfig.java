    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // P4a: 안전 상황판 — BP·ADMIN·CLIENT·공급사 공용(서비스에서 현장/인원 스코프 재검증). CLIENT 전역 차단의 예외.
                        .requestMatchers("/api/safety-board/**").hasAnyRole("ADMIN", "BP", "CLIENT", "EQUIPMENT_SUPPLIER", "MANPOWER_SUPPLIER")
