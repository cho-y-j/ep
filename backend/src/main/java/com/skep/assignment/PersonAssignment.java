...
/**
 * 인원 ↔ 현장 배치 이력. released_at 이 null 이면 현재 활성 배치다.
 * UNIQUE INDEX(person_id) WHERE released_at IS NULL — 자원당 활성 배치는 하나뿐.
 */
@Entity
@Table(name = "person_site_assignments")
@Getter
...
public class PersonAssignment {
    ...
    @Builder
    private PersonAssignment(Long personId, Long siteId, LocalDateTime assignedAt,
